...
function exibirProdutos(){
    ...
    listaProdutos.forEach(item => {
        ...
        codHtml += `<div class= "teste1"><img class="imagemNotebook" src="images copy/notebook completa.png" alt=""/><p>${item.nome} <br> (${qtd}) </p><b> <a href="javascript:void(0)"onclick="deletar(${index})"><img class="paraExcluir" src="./images copy/iconExcluir.png" alt=""></a></b>
        </div>
