...
function addCarrinhoMobile(){
    var notebook = {nome: "Notebook Acer Swift 3 SF314- <br> 57-57VY Intel Core I5 16GB...0", valor:"4109,00"}
...
function exibirProdutos(){
    ...
    listaProdutos.forEach(item => {
        ...
        codHtml += `<div class= "teste1"><img class="imagemNotebook" src="images copy/acerNitro1-PhotoRoom.png" alt=""><p>${item.nome}<br>(${qtd})</p><b><a href="javascript:void(0)"onclick="deletar(${index})"><img class="paraExcluir" src="./images copy/iconExcluir.png" alt=""></a></b></div><div class="linhaH1"></div>
        `
    ...
    if (document.getElementById('localNotebook2') != null){
        document.getElementById('localNotebook2').innerHTML = codHtml
    }
